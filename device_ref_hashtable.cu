...
void checkLast(const char* const file, const int line)
{
 ...
 { 
   ...
   auto map = cuco::static_map{capacity,
                              ...
                              cuco::empty_value{empty_pcell_sentinel}, // empty_cell_sentinel
